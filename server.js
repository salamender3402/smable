...
const boardTemplate = [
  ...
  { index: 1, name: "철광석 광산", composer: "고체", type: "music", era: "baroque", price: 150, upgradePrice: 75, baseToll: 30, tolls: [0,30,60,120,210], owner: null, level: 0,
  ...
  { index: 2, name: "흐르는 강물", composer: "액체", type: "music", era: "baroque", price: 180, upgradePrice: 90, baseToll: 35, tolls: [0,35,70,140,245], owner: null, level: 0,
  ...
  { index: 4, name: "바람개비 언덕", composer: "기체", type: "music", era: "baroque", price: 200, upgradePrice: 100, baseToll: 45, tolls: [0,45,90,180,315], owner: null, level: 0,
  ...
  { index: 5, name: "끊임없는 춤교실", composer: "입자", type: "music", era: "baroque", price: 220, upgradePrice: 110, baseToll: 55, tolls: [0,55,110,220,385], owner: null, level: 0,
    trivia: { question: "Q. 물질을 구성하는 입자들이 스스로 끊임없이 움직이는 현상을 무엇이라고 하는가?", options: ["입자 운동", "중력 운동", "정지 상태", "마찰 운동"], answer: "입자 운동" } },
  { index: 6, name: "향수가 퍼지는 방", composer: "확산", type: "music", era: "baroque", price: 230, upgradePrice: 115, baseToll: 60, tolls: [0,60,120,240,420], owner: null, level: 0,
  ...
  { index: 7, name: "입자 간격 비교실", composer: "입자 거리", type: "music", era: "baroque", price: 240, upgradePrice: 120, baseToll: 65, tolls: [0,65,130,260,455], owner: null, level: 0,
  ...
  { index: 9, name: "초콜릿 퐁듀 카페", composer: "융해", type: "music", era: "classical", price: 260, upgradePrice: 130, baseToll: 70, tolls: [0,70,140,280,490], owner: null, level: 0,
    trivia: { question: "Q. 고체 상태의 물질이 열에너지를 흡수하여 액체 상태로 변하는 현상을 무엇이라고 하는가?", options: ["융해", "응고", "기화", "액화"], answer: "융해" } },
  { index: 10, name: "바람 부는 빨래터", composer: "기화", type: "music", era: "classical", price: 280, upgradePrice: 140, baseToll: 80, tolls: [0,80,160,320,560], owner: null, level: 0,
  ...
  { index: 12, name: "얼음 조각 전시장", composer: "융해열", type: "music", era: "classical", price: 300, upgradePrice: 150, baseToll: 90, tolls: [0,90,180,360,630], owner: null, level: 0,
  ...
  { index: 13, name: "여름날의 분수대", composer: "기화열", type: "music", era: "classical", price: 320, upgradePrice: 160, baseToll: 100, tolls: [0,100,200,400,700], owner: null, level: 0,
  ...
  { index: 14, name: "땀이 마르는 언덕", composer: "기화열 흡수", type: "music", era: "classical", price: 330, upgradePrice: 165, baseToll: 105, tolls: [0,105,210,420,735], owner: null, level: 0,
  ...
  { index: 15, name: "드라이아이스 실험실", composer: "승화(흡열)", type: "music", era: "classical", price: 340, upgradePrice: 170, baseToll: 110, tolls: [0,110,220,440,770], owner: null, level: 0,
